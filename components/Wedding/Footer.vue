<template>
     <footer class="bg-gray-800 text-white text-center py-4">
      ...
      <p class="text-sm">Song by <a href="https://www.youtube.com/watch?v=Q0bTZbA0maw" target="_blank" class="hover:text-gray-300"><strong>Purity Javanese Gamelan Instrumental || Java Manika</strong></a></p>
